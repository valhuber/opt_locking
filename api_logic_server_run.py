...
==============================================================================
    ...
    This file initializes and starts the API Logic Server (v 08.02.01, April 21, 2023 19:47:30):
...
app_logger.info(f'Created April 21, 2023 19:47:30 at {str(current_path)}\n')
...
def create_app(swagger_host: str = "localhost", swagger_port: str = "5656"):
    ...
    with warnings.catch_warnings():
        ...
        with flask_app.app_context():
            ...
            from api.system import opt_locking
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 08.02.01\n'
    if is_docker():
    ...
    msg = f'API Logic Project Loaded (WSGI), version 08.02.01\n'
    if is_docker():
